## Admissions of Frail Older People  (Intermediate Frailty Risk) {#sec-frail_elderly_intermediate .unnumbered}
...
```{r global_variables}
cohort <- "frail_elderly_intermediate"
cohort_title <- "Admissions of Frail Older People  (Intermediate Frailty Risk)"
