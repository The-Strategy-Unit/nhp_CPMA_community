...
For the Frail Elderly High activity we show how much of the activity is included in mulitple other mitigable cohorts. Due to the definition of this mitigator all of those in this cohort are also in the Emergency Elderly cohort, so none of this group are solely in the Frail Elderly High cohort. One quarter of this cohort are included 5 or more additional mitigator cohorts.
...
tar_read(upset_plot_frail_elderly_high_episodes)
...
tar_read(upset_plot_frail_elderly_high_beddays)
...
#| fig-cap: Age and sex standardised rate of admissions for Frail Elderly High potentially mitigatable activity in England over the last 10 years. 

age_sex_standardised_rates_episodes<-tar_read(age_sex_standardised_rates_episodes)

plot_of_standardised_rates_over_time(age_sex_standardised_rates_episodes,"frail_elderly_high")
...
#| fig-cap: Age and sex standardised rate of beddays for Frail Elderly High potentially mitigatable activity in England over the last 10 years.

age_sex_standardised_rates_beddays<-tar_read(age_sex_standardised_rates_beddays)

plot_of_standardised_rates_over_time(age_sex_standardised_rates_beddays,"frail_elderly_high")
