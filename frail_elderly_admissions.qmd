...
targets::tar_read(total_beddays_episodes_frail_elderly_high) |>
  get_table_perc()
```
...
targets::tar_read(perc_frail_elderly_high_age_admissions) |>
  get_table_perc() 
```
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 2023-24 by age.
targets::tar_read(rates_frail_elderly_high_age_admissions) |>
...
targets::tar_read(perc_frail_elderly_high_ethnicity_admissions) |>
  get_table_perc() 
```
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 2023-24 by ethnic category.
targets::tar_read(rates_frail_elderly_high_ethnicity_admissions) |>
  get_rates_by_group_table() 
```
...
targets::tar_read(perc_frail_elderly_high_imd_admissions) |>
  get_table_perc() 
```
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 2023-24 by IMD decile.
targets::tar_read(rates_frail_elderly_high_imd_admissions) |>
  get_rates_by_group_table() 
```
...
targets::tar_read(perc_frail_elderly_high_sex_admissions) |>
  get_table_perc() 
```
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 2023-24 by sex.
targets::tar_read(rates_frail_elderly_high_sex_admissions) |>
  get_rates_by_group_table() 
```
