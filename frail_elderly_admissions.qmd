...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by age.
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by age.
targets::tar_read(perc_spells_frail_age) |>
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by ethnic category.
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by ethnic category.
targets::tar_read(perc_spells_frail_ethnicity) |>
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by IMD decile.
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by IMD decile.
targets::tar_read(perc_spells_frail_imd) |>
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by sex.
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by sex.
targets::tar_read(perc_spells_frail_sex) |>
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by icb.
...
#| tbl-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by length of stay.
frail_los <- targets::tar_read(perc_spells_frail_los) #|>
...
#| fig-cap: Mitigable activity for Frail and Elderly Admissions in 23-24 by length of stay.
frail_los |>
...
#| tbl-cap: Top 10 specialties of mitigable activity for Frail and Elderly Admissions in 23-24.
