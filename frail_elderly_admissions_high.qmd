...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "age group", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "age group", "emergency")
perc_frail_elderly_high_age_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "age group")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "age group")
rates_frail_elderly_high_age_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "ethnicity", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "ethnicity", "emergency")
perc_frail_elderly_high_ethnicity_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "ethnicity")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "ethnicity")
rates_frail_elderly_high_ethnicity_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "imd", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "imd", "emergency")
perc_frail_elderly_high_imd_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "imd")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "imd")
rates_frail_elderly_high_imd_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "sex", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "sex", "emergency")
perc_frail_elderly_high_sex_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "sex")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "admissions", "sex")
rates_frail_elderly_high_sex_admissions |>
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "age group", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "age group", "emergency")
targets::tar_read(perc_frail_elderly_high_age_beddays) |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "age group")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "age group")
targets::tar_read(rates_frail_elderly_high_age_beddays) |>
  get_rates_by_group_plot("age_range")
```
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "ethnicity", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "ethnicity", "emergency")
targets::tar_read(perc_frail_elderly_high_ethnicity_beddays) |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "ethnicity")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "ethnicity")
targets::tar_read(rates_frail_elderly_high_ethnicity_beddays) |>
  get_rates_by_group_plot("Ethnic_Category")
```
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "imd", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "imd", "emergency")
targets::tar_read(perc_frail_elderly_high_imd_beddays) |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "imd")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "imd")
targets::tar_read(rates_frail_elderly_high_imd_beddays) |>
  get_rates_by_group_plot("imd19_decile")
```
...
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "sex", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "beddays", "sex", "emergency")
targets::tar_read(perc_frail_elderly_high_sex_beddays) |>
...
#| tbl-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "sex")
...
#| fig-cap: !expr get_caption_by_group("rate", "Frail and Elderly (high)", "beddays", "sex")
targets::tar_read(rates_frail_elderly_high_sex_beddays) |>
  get_rates_by_group_plot("sex")
```
...
Of the 2023/24 mitigable admissions for frail and elderly (high) cohort, most (`r perc_frail_elderly_high_los |> dplyr::filter(weeks == 1) |> dplyr::pull(perc_weeks) |> purrr::pluck(1)`%) length of stays are under 1 week and `r perc_frail_elderly_high_los |> dplyr::filter(los_range == 0) |> dplyr::pull(perc)`% are less than 1 day.  

```{r}
#| label: tbl-perc_frail_elderly_high_los
#| tbl-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "los", "emergency")
...
#| fig-cap: !expr get_caption_by_group("perc", "Frail and Elderly (high)", "admissions", "los", "emergency")
...
Across both admissions and beddays, the largest two treatment functions for mitigable activity for the Frail and Elderly (high) cohort are Elderly Medicine Service and General Internal Medicine Service.
...
plotting_barchart_summary_of_overlaps(total_cohort_numbers_2324,"frail_elderly_high", episodes)
...
plotting_barchart_summary_of_overlaps(total_cohort_numbers_2324,"frail_elderly_high", beddays)
...
plot_upset_plot(total_cohort_numbers_2324, episodes)
...
plot_upset_plot(total_cohort_numbers_2324, beddays)
```
...
We aim to understand whether there have been decreases, or increases, in potentially mitigable Frail Elderly High activity over time. We have considered Frail Elderly High admissions and beddays over the past 9 years in England as a whole and for each ICB, including: 
a) the absolute number of Frail Elderly High admissions/beddays,
...
To help understand the variability between ICBs we have calculated for each ICB the percentage change in proportion of emergency admissions and in standardised rates between 2019/20 and 2023/24.
...
#| fig-cap: The total number of admissions for the Frail Elderly High mitigable activity cohort in England over the last 9 years. 

numbers_over_time<-tar_read(numbers_over_time)|>filter(year!="2014/15")
...
number_percentage_over_time<-  data_number_percentage_over_time_icb(denominator_over_time, 
                                    numbers_over_time,
                                       "frail_elderly_high",                                       total_episodes_emergency,
...
#| fig-cap: The total number of beddays for the Frail Elderly High mitigable activity cohort in England over the last 9 years. 
...
```{r}
#| output: false
summary_frail_elderly_high_la_admissions <- targets::tar_read(summary_frail_elderly_high_la_admissions)

la_23_shp <- sf::st_read("https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/Local_Authority_Districts_December_2024_Boundaries_UK_BGC/FeatureServer/0/query?outFields=*&where=1%3D1&f=geojson") |>
  janitor::clean_names() |>
  dplyr::filter(startsWith(lad24cd, "E"))

number_frail_elderly_high_la_admissions_map <- summary_frail_elderly_high_la_admissions |>
  get_summary_by_la_map(la_23_shp, "total_count")

perc_frail_elderly_high_la_admissions_map <- summary_frail_elderly_high_la_admissions |>
  get_summary_by_la_map(la_23_shp, "perc")

rate_frail_elderly_high_la_admissions_map <- summary_frail_elderly_high_la_admissions |>
  get_summary_by_la_map(la_23_shp, "value")
```
...
```{r}
#| label: fig-number_frail_elderly_high_la_admissions_bar
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "number", "admissions")
england_value <- get_england_value("total_count", 
                                   data_number = summary_frail_elderly_high_la_admissions)

get_summary_by_la_bar(summary_frail_elderly_high_la_admissions, 
                       "total_count", 
                       "frail_elderly_high",
                       england_value)
...
```{r}
#| label: fig-number_frail_elderly_high_la_admissions_map
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "number", "admissions")
number_frail_elderly_high_la_admissions_map
```
...
```{r}
#| label: fig-perc_frail_elderly_high_la_admissions_bar
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "perc", "admissions")
total_beddays_admissions <- targets::tar_read(total_beddays_admissions)
...
```{r}
#| label: fig-perc_frail_elderly_high_la_admissions_map
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "perc", "admissions", "emergency")
perc_frail_elderly_high_la_admissions_map
```
...
```{r}
#| label: fig-rate_frail_elderly_high_la_admissions_bar
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "SR", "admissions")
england_value <- get_england_value("value",
                                   data_rate = england_age_sex_standardised_rates_episodes,
                                   cohort = "frail_elderly_high")
...
```{r}
#| label: fig-rate_frail_elderly_high_la_admissions_map
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "SR", "admissions")
rate_frail_elderly_high_la_admissions_map
```
...
#| tbl-cap: !expr get_caption_by_icb_table("Frail Elderly (high)", "admissions", "emergency")
get_summary_by_la_table(summary_frail_elderly_high_la_admissions, "episodes", "emergency")
```
