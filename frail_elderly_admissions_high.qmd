...
get_summary_by_icb_bar(summary_frail_elderly_high_icb_admissions, "total_count")
```
...
get_summary_by_icb_bar(summary_frail_elderly_high_icb_admissions, "perc")
```
...
get_summary_by_icb_bar(summary_frail_elderly_high_icb_admissions, "value")
```
