...
plotting_percentage_change_over_time_by_icb(number_percentage_over_time, percentage_episodes, 1.6, 1.3)
...
plotting_percentage_change_over_time_by_icb(number_percentage_over_time, percentage_beddays, 1.6, 1.3)
...
plotting_percentage_change_over_time_by_icb(age_sex_standardised_rates_episodes, value, 1.3, 1.7)
...
plotting_percentage_change_over_time_by_icb(age_sex_standardised_rates_beddays, value, 1.4, 1.6)
