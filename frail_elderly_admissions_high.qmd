...
plotting_barchart_summary_of_overlaps(total_cohort_numbers_2324,"frail_elderly_high", episodes, mitigator_summary_table )
...
plotting_barchart_summary_of_overlaps(total_cohort_numbers_2324,"frail_elderly_high", beddays, mitigator_summary_table)
 ...
 data<- total_cohort_numbers_2324|>
  ...
  numbers_in_each_cohort<-data|>
   ...
   top_plot<-plot_data|>
    ...
    arrange(id)|>
    mutate(groups=reorder(groups, total_activity))
