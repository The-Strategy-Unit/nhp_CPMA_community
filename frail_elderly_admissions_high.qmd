...
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "perc", "admissions", treatment_type)
...
#| tbl-cap: !expr get_caption_by_icb_table("Frail Elderly (high)", "admissions", treatment_type)
get_summary_by_icb_table(summary_frail_elderly_high_icb_admissions, "episodes", treatment_type)
```
:::
...
#| tbl-cap: !expr get_caption_by_icb_table("Frail Elderly (high)", "admissions", treatment_type)
get_summary_by_la_table(summary_frail_elderly_high_la_admissions, "episodes", treatment_type)
```
:::
:::
