...
perc_frail_elderly_high_los_admissions_weeks <- perc_frail_elderly_high_los_admissions |>
  get_perc_by_los_weeks("admissions")
```
...
perc_frail_elderly_high_los_admissions_weeks |>
  get_perc_by_los_weeks_plot("admissions")
```
...
perc_frail_elderly_high_los_beddays_weeks <- perc_frail_elderly_high_los_beddays |>
  get_perc_by_los_weeks("beddays")
```
...
perc_frail_elderly_high_los_beddays_weeks |>
  get_perc_by_los_weeks_plot("beddays")
```
