...
targets::tar_read(perc_frail_elderly_high_los) |>
  get_perc_by_los_table("admissions")
```
...
perc_frail_elderly_high_los |>
  get_perc_by_los_plot("admissions")
```
...
plot_of_percentage_over_time(number_percentage_over_time, episodes, total_episodes)
...
plot_of_percentage_over_time(number_percentage_over_time,  beddays, total_beddays)
...
number_frail_elderly_high_icb_admissions <- summary_frail_elderly_high_icb_admissions |>
  get_summary_by_icb_plot(icb_23_shp, "total_count")

perc_frail_elderly_high_icb_admissions <- summary_frail_elderly_high_icb_admissions |>
  get_summary_by_icb_plot(icb_23_shp, "perc")

rate_frail_elderly_high_icb_admissions <- summary_frail_elderly_high_icb_admissions |>
  get_summary_by_icb_plot(icb_23_shp, "value")
```
...
```{r}
#| label: fig-number_frail_elderly_high_icb_admissions
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "number", "admissions")
number_frail_elderly_high_icb_admissions
```

#### Percentage of emergency activity

```{r}
#| label: fig-perc_frail_elderly_high_icb_admissions
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "perc", "admissions", "emergency")
perc_frail_elderly_high_icb_admissions
```

#### Age and sex standardised rates per 100,000 population

```{r}
#| label: fig-rate_frail_elderly_high_icb_admissions
#| fig-cap: !expr get_caption_by_icb("Frail Elderly (high)", "SR", "admissions")
rate_frail_elderly_high_icb_admissions
```
