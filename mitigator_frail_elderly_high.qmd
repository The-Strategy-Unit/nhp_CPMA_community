...
plotting_barchart_summary_of_overlaps(overlap_numbers,cohort, episodes, mitigator_summary_table )
...
plotting_barchart_summary_of_overlaps(overlap_numbers,cohort, beddays, mitigator_summary_table)
...
plot_upset_plot(overlap_numbers,  mitigator_summary_table, episodes)
...
plot_upset_plot(overlap_numbers,  mitigator_summary_table, beddays)
```
:::
