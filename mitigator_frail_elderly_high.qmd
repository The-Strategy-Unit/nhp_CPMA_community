## Admissions of Frail Older People (High Frailty Risk) {#sec-frail_elderly_high .unnumbered}
...
cohort_title <- "Admissions of Frail Older People (High Frailty Risk)"
cohort_group<- "cohort"
treatment_type <- "emergency"
treatment_type_title <- format_treatment_for_caption("emergency")
activity_type_label<-"admission/beddays"
```
