## Medically Unexplained Symptoms Admissions {#sec-medically_unexplained_related_admissions .unnumbered}
...
```{r global_variables}
cohort <- "medically_unexplained_related_admissions"
cohort_title <- "Medically Unexplained Symptoms Admissions"
