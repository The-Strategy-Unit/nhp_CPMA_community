## Virtual Wards LoS Reduction (Heart Failure) {#sec-virtual_wards_activity_avoidance_heart_failure .unnumbered}
...
```{r global_variables}
cohort <- "virtual_wards_activity_avoidance_heart_failure"
cohort_title <- "Virtual Wards LoS Reduction (Heart Failure)"
