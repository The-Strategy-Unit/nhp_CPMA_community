## Medicines Related Admissions (Implicit - Benzodiazepines) {#sec-medicines_related_admissions_implicit_benzodiasepines .unnumbered}
...
```{r global_variables}
cohort <- "medicines_related_admissions_implicit_benzodiasepines"
cohort_title <- "Medicines Related Admissions (Implicit - Benzodiazepines)"
