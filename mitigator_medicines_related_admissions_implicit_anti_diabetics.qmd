## Medicines Related Admissions (Implicit - Anti-Diabetics) {#sec-medicines_related_admissions_implicit_anti_diabetics .unnumbered}
...
```{r global_variables}
cohort <- "medicines_related_admissions_implicit_anti_diabetics"
cohort_title <- "Medicines Related Admissions (Implicit - Anti-Diabetics)"
