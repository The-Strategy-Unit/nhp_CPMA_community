## Medicines Related Admissions (Explicit) {#sec-medicines_related_admissions_explicit .unnumbered}
...
```{r global_variables}
cohort <- "medicines_related_admissions_explicit"
cohort_title <- "Medicines Related Admissions (Explicit)"
