## Stroke Early Supported Discharge {#sec-stroke_early_supported_discharge .unnumbered}
...
```{r global_variables}
cohort <- "stroke_early_supported_discharge"
cohort_title <- "Stroke Early Supported Discharge"
