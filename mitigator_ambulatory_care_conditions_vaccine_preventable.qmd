## Ambulatory Care Sensitive Admissions (Vaccine Preventable) {#sec-ambulatory_care_conditions_vaccine_preventable .unnumbered}
...
```{r global_variables}
cohort <- "ambulatory_care_conditions_vaccine_preventable"
cohort_title <- "Ambulatory Care Sensitive Admissions (Vaccine Preventable)"
