## End of Life Care Admissions (died within 3-14 days) {#sec-eol_care_3_to_14_days .unnumbered}
...
```{r global_variables}
cohort <- "eol_care_3_to_14_days"
cohort_title <- "End of Life Care Admissions (died within 3-14 days)"
