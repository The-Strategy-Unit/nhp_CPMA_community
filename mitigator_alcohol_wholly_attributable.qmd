## Alcohol Related Admissions (Wholly Attributable) {#sec-alcohol_wholly_attributable .unnumbered}
...
```{r global_variables}
cohort <- "alcohol_wholly_attributable"
cohort_title <- "Alcohol Related Admissions (Wholly Attributable)"
