## Ambulatory Care Sensitive Admissions (Acute Conditions) {#sec-ambulatory_care_conditions_acute .unnumbered}
...
```{r global_variables}
cohort <- "ambulatory_care_conditions_acute"
cohort_title <- "Ambulatory Care Sensitive Admissions (Acute Conditions)"
