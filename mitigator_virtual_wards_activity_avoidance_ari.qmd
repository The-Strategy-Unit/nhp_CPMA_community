## Virtual Wards LoS Reduction (Acute Respiratory Infection) {#sec-virtual_wards_activity_avoidance_ari .unnumbered}
...
```{r global_variables}
cohort <- "virtual_wards_activity_avoidance_ari"
cohort_title <- "Virtual Wards LoS Reduction (Acute Respiratory Infection)"
