## Admission With No Overnight Stay and No Procedure (Adults) {#sec-zero_los_no_procedure_adult .unnumbered}
...
```{r global_variables}
cohort <- "zero_los_no_procedure_adult"
cohort_title <- "Admission With No Overnight Stay and No Procedure (Adults)"
