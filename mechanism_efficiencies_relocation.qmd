## Mechanism: Efficiencies & Relocation {#sec-efficiencies_relocation .unnumbered}
...
```{r global_variables}
cohort <- "efficiencies_relocation"
cohort_title <- "Efficiencies & Relocation"
...
```{r}
overlap_numbers <- targets::tar_read(cohort_overlap_numbers_relocation) 
```
