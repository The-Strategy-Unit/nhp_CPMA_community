...
cohort_overlap_numbers_redirection<-targets::tar_read(cohort_overlap_numbers_redirection)
```
...
#| fig-cap: The number of mitigator cohorts that the admissions within the Redirection/Substition mechanism group are part of. It includes only admissions for mitigator cohorts within this Redirection/Substition mechanism group (2023/24).

plotting_barchart_number_of_cohorts_for_mechanism_group(cohort_overlap_numbers_redirection, episodes)
```
...
#| fig-cap: The number of mitigator cohorts that the beddays within the Redirection/Substition mechanism group are part of. It includes only beddays for mitigator cohorts within this Redirection/Substition mechanism group (2023/24).

plotting_barchart_number_of_cohorts_for_mechanism_group(cohort_overlap_numbers_redirection, beddays)
```
:::
...
#| fig-cap: The 15 most common mitigator cohort overlaps for admissions in the Redirection/Substition mechanism group (2023/24).

plot_upset_plot_mechanism_group(cohort_overlap_numbers_redirection,  mitigator_summary_table, episodes)
...
#| fig-cap: The 15 most common mitigator cohort overlaps for beddays in the Redirection/Substition mechanism group (2023/24).

plot_upset_plot_mechanism_group(cohort_overlap_numbers_redirection,  mitigator_summary_table, beddays)
...
england_value <- get_england_value(
  "total_count", 
  data = summary_icb_admissions_redirection_substitution)

get_summary_by_icb_bar(
  summary_icb_admissions_redirection_substitution, 
  "total_count", 
  cohort,
  england_value)
...
england_value <- get_england_value(
  ...
  data = overview_redirection_substitution,
  cohort = cohort)
...
england_value <- get_england_value(
  "total_count", 
  data = summary_icb_beddays_redirection_substitution)

get_summary_by_icb_bar(
  summary_icb_beddays_redirection_substitution, 
  "total_count", 
  cohort,
  england_value)
...
#| fig-cap: Table of the standardised rate of potentially mitigable Redirection and Substitution admissions by Local Authority over the last 5 years, including the percentage change between 2018/19 and 2023/24. 
...
#| fig-cap: Table of the standardised rate of potentially mitigable Redirection and Substitution beddays by Local Authority over the last 5 years, including the percentage change between 2018/19 and 2023/24.   
