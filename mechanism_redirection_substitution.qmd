...
```{r}
#| output: false
summary_redirection_substitution_icb_admissions <- targets::tar_read(summary_redirection_substitution_icb_admissions)
...
number_redirection_substitution_icb_admissions_map <- summary_redirection_substitution_icb_admissions |>
  get_summary_by_icb_map(icb_23_shp, "total_count")

perc_redirection_substitution_icb_admissions_map <- summary_redirection_substitution_icb_admissions |>
  get_summary_by_icb_map(icb_23_shp, "perc")

rate_redirection_substitution_icb_admissions_map <- summary_redirection_substitution_icb_admissions |>
...
```{r}
#| label: fig-number_redirection_substitution_icb_admissions_bar
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "admissions")
england_value <- get_england_value("total_count", 
                                   data_number = summary_redirection_substitution_icb_admissions)

get_summary_by_icb_bar(summary_redirection_substitution_icb_admissions, 
                       "total_count", 
                       cohort,
                       england_value)
...
```{r}
#| label: fig-number_redirection_substitution_icb_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "admissions")
number_redirection_substitution_icb_admissions_map
```
:::
...
```{r}
#| label: fig-perc_redirection_substitution_icb_admissions_bar
...
```{r}
#| label: fig-perc_redirection_substitution_icb_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "perc", "admissions", treatment_type)
perc_redirection_substitution_icb_admissions_map
```
:::
...
```{r}
#| label: fig-rate_redirection_substitution_icb_admissions_bar
...
```{r}
#| label: fig-rate_redirection_substitution_icb_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "admissions")
rate_redirection_substitution_icb_admissions_map
```
:::
...
```{r}
#| label: tbl-rate_redirection_substitution_icb_admissions
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "admissions", treatment_type, "icb")
get_summary_by_geography_table(summary_redirection_substitution_icb_admissions, "episodes", treatment_type)
```
:::
...
```{r}
#| label: tbl-rate_redirection_substitution_la_admissions
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "admissions", treatment_type, "la")
targets::tar_read(summary_redirection_substitution_la_admissions) |>
...
```{r}
#| output: false
summary_redirection_substitution_icb_beddays <- targets::tar_read(summary_redirection_substitution_icb_beddays)

number_redirection_substitution_icb_beddays_map <- summary_redirection_substitution_icb_beddays |>
  get_summary_by_icb_map(icb_23_shp, "total_count")

perc_redirection_substitution_icb_beddays_map <- summary_redirection_substitution_icb_beddays |>
  get_summary_by_icb_map(icb_23_shp, "perc")

rate_redirection_substitution_icb_beddays_map <- summary_redirection_substitution_icb_beddays |>
  get_summary_by_icb_map(icb_23_shp, "value")
```
...
```{r}
#| label: fig-number_redirection_substitution_icb_beddays_bar
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
england_value <- get_england_value("total_count", 
                                   data_number = summary_redirection_substitution_icb_beddays)

get_summary_by_icb_bar(summary_redirection_substitution_icb_beddays, 
                       "total_count", 
                       cohort,
                       england_value)
...
```{r}
#| label: fig-number_redirection_substitution_icb_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
number_redirection_substitution_icb_beddays_map
```
:::
...
```{r}
#| label: fig-perc_redirection_substitution_icb_beddays_bar
...
```{r}
#| label: fig-perc_redirection_substitution_icb_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "perc", "beddays", treatment_type)
perc_redirection_substitution_icb_beddays_map
```
:::
...
```{r}
#| label: fig-rate_redirection_substitution_icb_beddays_bar
...
```{r}
#| label: fig-rate_redirection_substitution_icb_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "beddays")
rate_redirection_substitution_icb_beddays_map
```
:::
...
```{r}
#| label: tbl-rate_redirection_substitution_icb_beddays
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "beddays", treatment_type, "icb")
get_summary_by_geography_table(summary_redirection_substitution_icb_beddays, "beddays", treatment_type)
```
:::
...
```{r}
#| label: tbl-rate_redirection_substitution_la_beddays
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "beddays", treatment_type, "la")
targets::tar_read(summary_redirection_substitution_la_beddays) |>
