...
#| fig-cap: !expr glue::glue("{get_caption_number_of_cohorts(cohort_title, 'admissions')} It includes only admissions for mitigator cohorts within this {cohort_title} group.")
...
#| fig-cap: !expr glue::glue("{get_caption_number_of_cohorts(cohort_title, 'beddays')} It includes only beddays for mitigator cohorts within this {cohort_title} group.")
