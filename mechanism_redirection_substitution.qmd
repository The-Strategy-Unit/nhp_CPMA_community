...
```{r}
perc_redirection_substitution_los <- targets::tar_read(perc_redirection_substitution_los)
```
...
targets::tar_read(perc_redirection_substitution_los) |>
...
targets::tar_read(redirection_substitution_specialties_top_ten_admissions) |>
  get_table_perc() 
```
...
targets::tar_read(redirection_substitution_specialties_top_ten_beddays) |>
  get_table_perc() 
```
