...
The majority of potentially mitigable admissions (57%) are purely for activity where there could be redirection to perhaps community services. Just over a fifth of potentially mitigable activity (22%) is activity that could be prevented perhaps through public health initiatives.
...
There is a significant proportion of beddays that fall into both the Redirection and Efficiencies mechanism groups (44%).
...
Over the last 5 years (2018/19 to 2023/24), there has been a `r england_average_numbers_episodes$change` % increase the percentage of admissions that are for potentially mitigable activity and a `r england_average_numbers_beddays$change` % increase in the percentage of beddays that are for potentially mitigable activity.
