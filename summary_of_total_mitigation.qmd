...
![Groupings of the mitgators by mechanism of mitigation groups. Activity avoidance mitigators in yellow impact the number of admissions and therefore also beddays. Efficiency mitigators in grey will impact length of stay, and so only affect beddays.](summary_flow_chart.png){#fig-summary_flow-chart}
