...
In 2023/24 in England there were **`r format(total_mitigator_activity$episodes, big.mark=",")` admissions (`r england_average_percentage_episodes$percentage`%)** and **`r format(total_mitigator_activity$beddays, big.mark=",")` beddays (`r england_average_percentage_beddays$percentage`%)** for potentially mitigable activity. This total excludes any double counting as a result of activity being including in multiple mitigator cohorts.
