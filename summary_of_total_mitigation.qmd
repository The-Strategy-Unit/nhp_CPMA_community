...
```{r}
#| output: false
summary_icb_all_admissions <- targets::tar_read(summary_icb_all_admissions)
...
number_icb_all_admissions_map <- summary_icb_all_admissions |>
  get_summary_by_icb_map(icb_23_shp, "total_count")

perc_icb_all_admissions_map <- summary_icb_all_admissions |>
  get_summary_by_icb_map(icb_23_shp, "perc")

rate_icb_all_admissions_map <- summary_icb_all_admissions |>
...
```{r}
#| label: fig-number_icb_all_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "admissions")
number_icb_all_admissions_map
```
:::
...
```{r}
#| label: fig-perc_icb_all_admissions_bar
...
```{r}
#| label: fig-perc_icb_all_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "perc", "admissions", treatment_type)
perc_icb_all_admissions_map
```
:::
...
```{r}
#| label: fig-rate_icb_all_admissions_bar
...
```{r}
#| label: fig-rate_icb_all_admissions_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "admissions")
rate_icb_all_admissions_map
```
:::
...
```{r}
#| label: tbl-rate_icb_all_admissions
...
```{r}
#| output: false
summary_icb_all_beddays <- targets::tar_read(summary_icb_all_beddays)

number_icb_all_beddays_map <- summary_icb_all_beddays |>
  get_summary_by_icb_map(icb_23_shp, "total_count")

perc_icb_all_beddays_map <- summary_icb_all_beddays |>
  get_summary_by_icb_map(icb_23_shp, "perc")

rate_icb_all_beddays_map <- summary_icb_all_beddays |>
  get_summary_by_icb_map(icb_23_shp, "value")
```
...
```{r}
#| label: fig-number_icb_all_beddays_bar
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
england_value <- get_england_value(
  "total_count", 
  data = summary_icb_all_beddays)

get_summary_by_icb_bar(
  summary_icb_all_beddays, 
  "total_count", 
  cohort,
  england_value)
...
```{r}
#| label: fig-number_icb_all_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
number_icb_all_beddays_map
```
:::
...
```{r}
#| label: fig-perc_icb_all_beddays_bar
...
```{r}
#| label: fig-perc_icb_all_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "perc", "beddays", treatment_type)
perc_icb_all_beddays_map
```
:::
...
```{r}
#| label: fig-rate_icb_all_beddays_bar
...
```{r}
#| label: fig-rate_icb_all_beddays_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "beddays")
rate_icb_all_beddays_map
```
:::
...
```{r}
#| label: tbl-rate_icb_all_beddays
...
#| fig-cap: Table of the standardised rate of potentially mitigable admissions over time by local authority area. 
...
#| fig-cap: Table of the standardised rate of potentially mitigable beddays over time by local authority area. 
