## Medicines Related Admissions (Implicit - Diuretics) {#sec-medicines_related_admissions_implicit_diurectics .unnumbered}
...
```{r global_variables}
cohort <- "medicines_related_admissions_implicit_diurectics"
cohort_title <- "Medicines Related Admissions (Implicit - Diuretics)"
