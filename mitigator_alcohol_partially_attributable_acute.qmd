## Alcohol Related Admissions (Acute Conditions - Partially Attributable) {#sec-alcohol_partially_attributable_acute .unnumbered}
...
```{r global_variables}
cohort <- "alcohol_partially_attributable_acute"
cohort_title <- "Alcohol Related Admissions (Acute Conditions - Partially Attributable)"
