## Alcohol Related Admissions (Chronic Conditions - Partially Attributable) {#sec-alcohol_partially_attributable_chronic .unnumbered}
...
```{r global_variables}
cohort <- "alcohol_partially_attributable_chronic"
cohort_title <- "Alcohol Related Admissions (Chronic Conditions - Partially Attributable)"

treatment_type <- "both"
cohort_group <- "cohort"
treatment_type_title <- format_treatment_for_caption("both")
```
