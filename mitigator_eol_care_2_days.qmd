## End of Life Care Admissions (died within 2 days) {#sec-eol_care_2_days .unnumbered}
...
```{r global_variables}
cohort <- "eol_care_2_days"
cohort_title <- "End of Life Care Admissions (died within 2 days)"
