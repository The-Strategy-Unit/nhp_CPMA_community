...
For the `r cohort_title` activity the percentage and number of `r activity_type_label` included in multiple other mitigable cohorts is shown. 

```{r}
if(cohort_title %in% c("Efficiencies","Stroke Early Supported Discharge", "Admissions with Mental Health Comorbidities", "Emergency Admissions of Older People")) {
