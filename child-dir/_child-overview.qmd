...
if(include_admissions) {
  ...
  admissions_statement <- glue::glue(
    "{admissions_number} potentially mitigable admissions accounting for {admissions_perc}% of {treatment_type_title} admissions"
  )
} else {
...
if (include_beddays) {
  ...
  beddays_statement <- glue::glue(
    "{beddays_number} potentially mitigable beddays accounting for {beddays_perc}% of {treatment_type_title} beddays"
  )
} else {
  beddays_statement <- ""
}
