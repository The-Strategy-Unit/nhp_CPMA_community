...
::: {#fig-number_icb_admissions layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "number", "admissions")`
...
::: {#fig-number_icb_beddays layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "number", "beddays")`
...
::: {#fig-perc_icb_admissions layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "perc", "admissions", treatment_type)`
...
::: {#fig-perc_icb_beddays layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "perc", "beddays", treatment_type)`
...
::: {#fig-rate_icb_admissions layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "rate", "admissions", treatment_type)`
...
::: {#fig-rate_icb_beddays layout="[62, 38]"}
...
`r get_caption_by_geography(cohort_title, "rate", "beddays", treatment_type)`
