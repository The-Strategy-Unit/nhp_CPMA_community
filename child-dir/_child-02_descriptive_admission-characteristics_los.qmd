...
los_trends_range_caption <- glue::glue("{los_caption |> stringr::str_remove('in 2023/24 ') |> stringr::str_replace('range.', 'range')} over time.")

avg_los_england_caption <- get_caption_trends(cohort_title, "avg_los", cohort_group, "admissions", "england") |>
  stringr::str_replace("the last 9 years", "time")

avg_los_icb_caption <- get_caption_trends(cohort_title, "avg_los", cohort_group, "admissions", "icb")  |>
  stringr::str_replace("the last 9 years", "time")
```
...
#| fig-cap: !expr los_trends_range_caption
...
#| tbl-cap: !expr los_trends_range_caption
perc_los_trends_range |>
...
#| tbl-cap: !expr avg_los_england_caption
avg_los_england |>
  dplyr::arrange(year) |>
  get_table_perc()
```
...
#| fig-cap: !expr avg_los_england_caption
avg_los_england |>
...
#| fig-cap: !expr avg_los_icb_caption
avg_los_icb |>
