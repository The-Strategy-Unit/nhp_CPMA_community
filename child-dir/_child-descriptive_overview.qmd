...
statement <- if(cohort == "efficiencies") { 
  glue::glue("{beddays_perc}% of {treatment_type_title} beddays") 
} else if (cohort == "zero_los_no_procedure_adult" | cohort == "zero_los_no_procedure_child") {
  glue::glue("{admissions_perc}% of {treatment_type_title} admissions")
}  else {
  glue::glue("{admissions_perc}% of {treatment_type_title} admissions and {beddays_perc}% of {treatment_type_title} beddays")
}
```
