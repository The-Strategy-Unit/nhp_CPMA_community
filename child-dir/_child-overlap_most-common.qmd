...
```{r}
if(cohort_title %in% c("Efficiencies")) {
most_common_cohort_text<-""
 } else{
most_common_cohort_text<-"The 15 most common cohort combinations for the `r cohort_title` cohort are shown. All cohort combinations together will add to 100%."
  }
