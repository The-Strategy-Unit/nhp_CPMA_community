## Emergency Readmissions Within 28 Days {#sec-readmission_within_28_days .unnumbered}
...
```{r global_variables}
cohort <- "readmission_within_28_days"
cohort_title <- "Emergency Readmissions Within 28 Days"
