...
rates_frail_elderly_high_age_admissions <- targets::tar_read(rates_age_frail_elderly_high_admissions)
```
...
rates_frail_elderly_high_ethnicity_admissions <- targets::tar_read(rates_ethnicity_frail_elderly_high_admissions)
```
...
rates_frail_elderly_high_imd_admissions <- targets::tar_read(rates_imd_frail_elderly_high_admissions)
```
...
rates_frail_elderly_high_sex_admissions <- targets::tar_read(rates_sex_frail_elderly_high_admissions)
```
...
```{r}
perc_frail_elderly_high_los <- targets::tar_read(perc_los_frail_elderly_high)
```
...
targets::tar_read(specialties_top_ten_frail_elderly_high_admissions) |>
  get_table_perc() 
```
...
targets::tar_read(specialties_top_ten_frail_elderly_high_beddays) |>
  get_table_perc() 
```
