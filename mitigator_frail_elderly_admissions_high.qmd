...
get_summary_by_geography_table(summary_icb_admissions_frail_elderly_high, "episodes", treatment_type)
```
:::
...
england_value <- get_england_value("total_count", 
                                   data_number = summary_icb_beddays_frail_elderly_high)

get_summary_by_icb_bar(summary_icb_beddays_frail_elderly_high, 
                       "total_count", 
                       cohort,
                       england_value)
...
get_summary_by_geography_table(summary_icb_beddays_frail_elderly_high, "beddays", treatment_type)
```
:::
