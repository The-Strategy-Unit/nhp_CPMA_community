...
england_value <- get_england_value(
  "total_count", 
  data = summary_icb_admissions_frail_elderly_high)

get_summary_by_icb_bar(
  summary_icb_admissions_frail_elderly_high, 
  "total_count", 
  cohort,
  england_value)
...
england_value <- get_england_value(
  ...
  data = overview_frail_elderly_high,
  cohort = cohort)
...
england_value <- get_england_value(
  "value",
  data = england_age_sex_standardised_rates_episodes,
  cohort = cohort)
...
```{r}
#| label: tbl-rate_la_admissions_frail_elderly_high
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "admissions", treatment_type, "la")
targets::tar_read(summary_la_admissions_frail_elderly_high) |>
...
```{r}
#| output: false
summary_icb_beddays_frail_elderly_high <- targets::tar_read(summary_icb_beddays_frail_elderly_high)

number_icb_beddays_frail_elderly_high_map <- summary_icb_beddays_frail_elderly_high |>
  get_summary_by_icb_map(icb_23_shp, "total_count")

perc_icb_beddays_frail_elderly_high_map <- summary_icb_beddays_frail_elderly_high |>
  get_summary_by_icb_map(icb_23_shp, "perc")

rate_icb_beddays_frail_elderly_high_map <- summary_icb_beddays_frail_elderly_high |>
  get_summary_by_icb_map(icb_23_shp, "value")
```
...
```{r}
#| label: fig-number_icb_beddays_frail_elderly_high_bar
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
england_value <- get_england_value(
  "total_count", 
  data = summary_icb_beddays_frail_elderly_high)

get_summary_by_icb_bar(
  summary_icb_beddays_frail_elderly_high, 
  "total_count", 
  cohort,
  england_value)
...
```{r}
#| label: fig-number_icb_beddays_frail_elderly_high_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "number", "beddays")
number_icb_beddays_frail_elderly_high_map
```
:::
...
```{r}
#| label: fig-perc_icb_beddays_frail_elderly_high_bar
...
```{r}
#| label: fig-perc_icb_beddays_frail_elderly_high_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "perc", "beddays", treatment_type)
perc_icb_beddays_frail_elderly_high_map
```
:::
...
```{r}
#| label: fig-rate_icb_beddays_frail_elderly_high_bar
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "beddays")
england_value <- get_england_value(
  "value", 
  data = england_age_sex_standardised_rates_beddays, 
  cohort = cohort)
...
```{r}
#| label: fig-rate_icb_beddays_frail_elderly_high_map
#| fig-cap: !expr get_caption_by_icb(cohort_title, "SR", "beddays")
rate_icb_beddays_frail_elderly_high_map
```
:::
...
```{r}
#| label: tbl-rate_icb_beddays_frail_elderly_high
...
```{r}
#| label: tbl-rate_la_beddays_frail_elderly_high
#| tbl-cap: !expr get_caption_by_geography_table(cohort_title, "beddays", treatment_type, "la")
targets::tar_read(summary_la_beddays_frail_elderly_high) |>
...
#| fig-cap: The number of admissions for the Frail Older People (high frailty) cohort in England over the last 9 years. 
...
#| fig-cap: The number of beddays for the Frail Older People (high frailty) cohort in England over the last 9 years. 
...
#| fig-cap: The percentage of emergency admissions for Frail Older People (high frailty) activity in England over the last 9 years. 
...
#| fig-cap: The percentage of emergency beddays for Frail Older People (high frailty) activity in England over the last 9 years. 
...
#| fig-cap: Age and sex standardised rate of Frail Older People (high frailty) admissions in England over the last 9 years. 
...
#| fig-cap: Age and sex standardised rate of Frail Older People (high frailty) beddays in England over the last 9 years.
...
#| fig-cap: The number of admissions for the Frail Older People (high frailty) cohort by ICB over the last 9 years. 
...
#| fig-cap: The number of beddays for the Frail Older People (high frailty) cohort by ICB over the last 9 years. 
...
#| fig-cap: The percentage of emergency admissions for Frail Older People (high frailty) activity by ICB over the last 9 years. 
...
#| fig-cap: The percentage change in the proportion emergency admissions for the Frail Older People (high frailty) cohort by ICB between 2018/19 and 2023/24. 
...
#| fig-cap: The percentage of emergency beddays for Frail Older People (high frailty) activity by ICB over the last 9 years. 
...
#| fig-cap: The percentage change in the proportion emergency beddays for the Frail Older People (high frailty) cohort by ICB between 2018/19 and 2023/24. 
...
#| fig-cap: Age and sex standardised rate of Frail Older People (high frailty) admissions by ICB over the last 9 years. 
...
plotting_percentage_change_over_time_by_icb(icb_age_sex_standardised_rates_episodes|> 
     filter(cohorts==cohort), value, icb_2024_name, england_average_standardised_episodes$change, 1.6, 1.7)
...
#| fig-cap: Age and sex standardised rate of Frail Older People (high frailty) beddays by ICB over the last 9 years. 
...
plotting_percentage_change_over_time_by_icb(icb_age_sex_standardised_rates_beddays|> 
     filter(cohorts==cohort), value, icb_2024_name, england_average_standardised_beddays$change, 1.6, 1.6)
...
#| fig-cap: The standardised rate of Frail Older People (high frailty) beddays (in 2018/19) versus the percentage change in beddays between 2018/19 and 2023/24 for ICBs. 
...
#| fig-cap: Table of the standardised rate of Frail Older People (high frailty) admissions over time for local authorities. 
...
#### Change in age and sex standardised rate over time relative to level of activity by Local Authority

This chart shows the percentage change for each LA relative to it's starting level of admissions/beddays to help demonstrate performance across LAs. Those LAs in the lower left quadrant (shaded in green) could be considered as performing well; they already had relatively low standardised rates of admissions/beddays in 2018/19 and have continued to make further decreases over the last five years.

::: panel-tabset
#### Admissions

```{r, fig.width=5, fig.height=4}
#| label: fig-activity_vs_rate_of_change_episodes_la
#| fig-cap: The standardised rate of Frail Older People (high frailty) admissions (in 2018/19) versus the percentage change in admissions between 2018/19 and 2023/24 for for Local Authorities. 
...
```{r, fig.width=5, fig.height=4}
#| label: fig-activity_vs_rate_of_change_beddays_la
#| fig-cap: The standardised rate of Frail Older People (high frailty) beddays (in 2018/19) versus the percentage change in beddays between 2018/19 and 2023/24 for Local Authorities. 
